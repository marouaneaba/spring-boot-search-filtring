...
public class BookEntity {
    ...
    public BookEntity(UUID id, String name, String isbn, BookType bookType, String country, ZonedDateTime createDate) {
        this.id = id;
        this.name = name;
        this.isbn = isbn;
    ...
    public static Book toBook(BookEntity from) {
        return new Book(from.name, from.isbn, from.bookType, from.country, from.createDate);
    }
